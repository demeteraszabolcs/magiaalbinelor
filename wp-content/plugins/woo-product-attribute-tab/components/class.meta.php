...
class Meta {
     ...
     */
    public function get_taxonomy_fields($defaults=null) {
        $fields = array(

            'attribute_display_type' => array(
            ...
            'attribute_description_source' => array(
                'name'    => __('Description source', 'woo-product-attribute-tab' ),
                'type'    => 'select',
                'id'      => 'attribute_description_source',
